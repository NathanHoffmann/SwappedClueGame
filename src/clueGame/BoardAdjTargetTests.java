...
Assert.assertTrue(testList.contains(board.getCellAt(19, 13)));
...
Assert.assertTrue(testList.contains(board.getCellAt(14, 2)));
...
Assert.assertTrue(targets.contains(board.getCellAt(13, 6)));
...
Assert.assertTrue(targets.contains(board.getCellAt(14, 5)));
Assert.assertTrue(targets.contains(board.getCellAt(16, 5)));
Assert.assertTrue(targets.contains(board.getCellAt(13, 4)));
Assert.assertTrue(targets.contains(board.getCellAt(15, 4)));	
...
Assert.assertTrue(targets.contains(board.getCellAt(14, 10)));	
