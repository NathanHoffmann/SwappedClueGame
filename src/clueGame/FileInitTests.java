...
public class FileInitTests {
	...
	public static void setUp() throws FileNotFoundException, BadConfigFormatException {
		ClueGame game = new ClueGame("ClueLayout.csv", "Legend.txt");
	...
	public void testRooms() {
		...
		assertEquals("Theater Room", rooms.get('T'));
	...
	public void FourDoorDirections() {
		...
		RoomCell room = board.getRoomCellAt(4, 13);
		assertTrue(room.isDoorway());
		assertEquals(RoomCell.DoorDirection.RIGHT, room.getDoorDirection());
		room = board.getRoomCellAt(12, 18);
		assertTrue(room.isDoorway());
		assertEquals(RoomCell.DoorDirection.DOWN, room.getDoorDirection());
		room = board.getRoomCellAt(16, 15);
		assertTrue(room.isDoorway());
		assertEquals(RoomCell.DoorDirection.LEFT, room.getDoorDirection());
		room = board.getRoomCellAt(14, 1);
		assertTrue(room.isDoorway());
	...
	public void testNumberOfDoorways() 
	{
		...
		Assert.assertEquals(504, totalCells);
	...
	public void testRoomInitials() {
		assertEquals(new Character('T'), board.getRoomCellAt(0, 0).getInitial());
		assertEquals(new Character('D'), board.getRoomCellAt(4, 8).getInitial());
		assertEquals(new Character('P'), board.getRoomCellAt(9, 0).getInitial());
		assertEquals(new Character('B'), board.getRoomCellAt(21, 20).getInitial());
		assertEquals(new Character('L'), board.getRoomCellAt(21, 0).getInitial());
	}
